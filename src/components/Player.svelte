<script>
	import { audioData } from '$components/audiodata.js';
	
	import TrackHeading from '$components/TrackHeading.svelte';
	import ProgressBarTime from '$components/ProgressBarTime.svelte';
